...
export default function CheckoutPage() {
  ...
  const handleAutoFillManualAddress = () => {
                ...
                <>
                  ...
                  {useManualAddress && (
                    <div className="space-y-4 p-4 bg-gray-50 rounded-xl">
                      <button
                        type="button"
                        onClick={handleAutoFillManualAddress}
                        disabled={geoLoading}
                        className="w-full flex items-center justify-center gap-2 py-3 border-2 border-gray-200 rounded-xl bg-white hover:border-[#e4002b] hover:text-[#e4002b] transition-all text-sm font-semibold"
                      >
                        {geoLoading ? (
                        ...
                        {geoLoading ? "Identifying location..." : "Use current location"}
                      </button>
