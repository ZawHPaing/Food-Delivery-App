...
export default function Home() {
  ...
  const checkLocation = async () => {
    ...
    if (!isLoggedIn) {
      // For guests, we might not have a database record. 
      // Do we want to show the popup for guests too?
      // For now, let's assume it's for logged-in users as it checks the 'addresses table'.
      return;
    }
    ...
    try {
      ...
      // User requested to show it EVERY time on reload if logged in
