...
from ..models.delivery_models import (
    ...
    UpdateRiderLocationRequest, UpdateRiderLocationResponse
)
...
@router.post("/location", response_model=UpdateRiderLocationResponse)
def update_rider_location(request: UpdateRiderLocationRequest):
